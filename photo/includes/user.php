...
//this class is the user where it helps to do all the work without going to the database class. 
class user {
	
//these are the objects that will be used as attributes which will hold the data from mysql. they should be identical to the attributes in mysql database.
