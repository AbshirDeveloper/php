                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div id="cart_total">	
                                    <font id="font" size="80"><?php echo "$"; ?></font></br>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            ?> 
                            <tr id="le">
                            <td id="nam"><?php echo 'name'; ?></td>
                            <td id="amoun"><?php echo 'amount'; ?></td>
                            <td id="tota"><?php echo "$".'total'; ?></td>
                            </tr>
                            <?php
                            ?>
                            </table>
