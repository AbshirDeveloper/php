...
?>
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;"><center>Somali-Weyn Pharmacy</center></font>
<div id="mainmain">
...
<a rel="facebox" href="addcustomer.php"><i class="icon-group icon-2x"></i><br>Register Cashier</a>  	
