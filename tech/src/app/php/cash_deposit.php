...
$sql_cash = "select sum(amount) as total from cash where status = 'Deposited'";
...
VALUES ('$today_real', '$data', $sum_cashe, 'Approved')";
$qry = mysqli_query($connection, $sql);

$w = "delete from cash where status = 'Deposited'";
