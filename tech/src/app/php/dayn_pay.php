...
$dayn = "select sum(amount) as total from dayn where id=$dat->id";
...
$day = "select sum(paid) as total from dayn where id=$dat->id";
    $result = mysqli_query($connection, $day);
while ($row = mysqli_fetch_assoc($result)){
    $sumse = $row['total'];

}

$balance =  $sums - ($sumse + $dat->paid);
$paid = $sumse + $dat->paid;
