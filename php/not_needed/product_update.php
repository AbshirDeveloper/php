...
SET description='$data->description', quantity='$data->quantity', whole_sale='$data->whole_sale', retail_sale='$data->retail_sale', barcode='$data->barcode'WHERE id=$data->id limit 1";    
