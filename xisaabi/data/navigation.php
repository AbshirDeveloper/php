	...
	<a href="Office_needs.php"><button id="button"><h2>Store needs</h2></button></a></br>
	...
	<hr />
	<h2 id="sagaal"><?php echo "if you are not " . "" . $_SESSION['first_name']. ", please "; ?> <a id="logout" href="../pages/logout.php">Logout</a></h2> <br/>
