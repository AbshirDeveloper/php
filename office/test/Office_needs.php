...
<?php
	...
	$phpexcel->getactivesheet()->setcellvalue("B2", "Name");
	$phpexcel->getactivesheet()->setcellvalue("C2", "Barcode");
	$phpexcel->getactivesheet()->setcellvalue("D2", "Amount");
	$phpexcel->getactivesheet()->setcellvalue("E2", "Total");
...
<div id="info"><?php $weight = $public->select_sum_column('products', 'weight', $array['id']);  echo "Customer Weight:" . " " . $weight;?></div><?php
echo "<br/>";
?>
</div>
