...
<section id="home" class="parallax-section">
  <div class="gradient-overlay"></div>
          ...
          <div class="col-md-offset-2 col-md-8 col-sm-12">
              <h1 class="wow fadeInUp" data-wow-delay="0.6s">Techsom</h1>
...
<div class="login-page">
  <div class="form">
    <form id="class" class="login-form" action="Web/authen.php" method="post">
    <span id="red"></span>
    <br/>
    <br/>
      <input id="labo" type="text" name="username" value="" />
      <input id="labo" type="password" name="password" value="" />
