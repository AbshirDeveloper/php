...
if(isset($_GET['id'])){
global $connection;
$query = "delete from data where id_customer = {$_SESSION['id']}";
mysqli_query($connection, $query);
    ...
    $public->update_invent($array, 'data', 'product_name', $name);
    header("location: inventory.php?page=0");
...
?>
    <div id="input">
        ...
        <form id="for" action="../data/register_products.php" method="post">
...
<h3>Expiring Products (This feature is coming soon...)</h3>
</div>
