...
<div class="login-page">
  <div class="form">
    ...
    <span id="green">Reset your password</span><br />
    <br />
    <span id="red"></span>
    <br/>
    <br/>
      <input id="labo" type="password" name="new_password" placeholder="New Password"/>
      <input id="sadex" type="password" name="confirm_password" placeholder="Confirm Password"/>
...
function event() {
  ...
  if(document.getElementById("labo").value == "" || document.getElementById("labo").value !== document.getElementById("sadex").value){
  document.getElementById("red").innerHTML = "Please provide matching passwords";
  return false;
} else {
...
<div class="login-page">
  <div class="form">
    <form id="class" class="login-form" action="password_reset.php" method="post">
    <span id="red">This link is invalid</span><br />
