   ...
   <!-- #region Jssor Slider Begin -->
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:1300px;height:500px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1300px;height:500px;overflow:hidden;">
            <a data-u="any" href="http://www.jssor.com" style="display:none">Somtruck</a>
            <div>
                <img data-u="image" src="img/ship3.jpg" />
                <div style="position:absolute;top:30px;left:30px;width:480px;height:120px;z-index:0;font-size:50px;color:black;line-height:60px;">Somtruck, The best Shipping Company <br/> to Africa</div>
                <div style="position:absolute;top:300px;left:30px;width:480px;height:120px;z-index:0;font-size:30px;color:black;line-height:38px;">Somtruck....</div>
            </div>
            <div>
                <img data-u="image" src="img/shop1.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/shop2.jpg" />
            </div>
        </div>
        <!-- Bullet Navigator -->
