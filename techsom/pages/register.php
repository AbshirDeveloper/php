...
City <input id="labo" type="text" name="city" value=""></br>
</br>
Zip Code <input id="labo" type="number" name="zip_code" value=""></br>
</br>
...
function event() {
					...
					if(document.getElementById("mid").value == "" || document.getElementById("labo").value == "" || document.getElementById("sadex").value == "" || document.getElementById("afar").value == "" || document.getElementById("shan").value == ""|| document.getElementById("afar").value !== document.getElementById("shan").value || document.getElementById("box").value == "Select your Bussiness"){
					document.getElementById("error").innerHTML = "Please fill all the fields and make sure that your two passwords are equal and select appropriate bussiness type";
					return false;
					} else {
