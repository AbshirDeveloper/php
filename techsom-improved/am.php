...
$sql="SELECT sum(balance) as total FROM amano where date > $yesterday";
...
$sq="SELECT sum(balance) as total FROM amano where date > $lastweek";
...
$s="SELECT sum(balance) as total FROM amano where date > $lastmonth";
