...
<div class="header">
			...
			<div class="about-box">
				...
				<div class="col_1_of_3 grid_1_of_3">
				 ...
				 <div class="history-desc">
					...
					<p class="history">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitati.</p>
				 <div class="clear"></div>
				</div>
			</div>
				<div class="col_1_of_3 grid_1_of_3">
	...
	<div class="content-bottom">
		<div class="wrap">
			<div class="box-unit"><h1>Lorem ipsum dolor sit amet?</h1><p>Sed ut perspiciatis unde oiste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nem ipsam voluptatem quia voluptas sit aspernatur aut. </p></div>
			<div class="section group">
				<div class="col_1_of_4 span_1_of_4">
					<div class="bottom-grid">
					  <div class="grid_icon"><img src="images/heart.png" alt=""/></div>
				...
				<div class="col_1_of_4 span_1_of_4">
					<div class="bottom-grid">
					  <div class="grid_icon"><img src="images/flower.png" alt=""/></div>
					  <h3>Lorem Ipsum is simply</h3>
					</div>
					<div class="service-box">Quisque nulla. Vestibulum libero nisl, porta vel, scelerisque eget, lesuada at, neque. Viv eget nibh. Etam cus. Nulla facilisi. Aenean nec eros. Vestibulum ante. </div>
				</div>
				<div class="col_1_of_4 span_1_of_4">
					<div class="bottom-grid">
					  <div class="grid_icon"><img src="images/cake.png" alt=""/></div>
					  <h3>Lorem Ipsum is simply</h3>
					</div>
					<div class="service-box">Quisque nulla. Vestibulum libero nisl, porta vel, scelerisque eget, lesuada at, neque. Viv eget nibh. Etam cus. Nulla facilisi. Aenean nec eros. Vestibulum ante. </div>
				</div>
				<div class="col_1_of_4 span_1_of_4">
					<div class="bottom-grid">
					  <div class="grid_icon"><img src="images/heart1.png" alt=""/></div>
					  <h3>Lorem Ipsum is simply</h3>
					</div>
					<div class="service-box">Quisque nulla. Vestibulum libero nisl, porta vel, scelerisque eget, lesuada at, neque. Viv eget nibh. Etam cus. Nulla facilisi. Aenean nec eros. Vestibulum ante. </div>
				</div>
