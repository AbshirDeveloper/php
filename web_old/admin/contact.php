...
<!--	update form			-->
	...
	<input type="text" name="facebook" value="<?php echo $result['f_link']; ?>"><br />
	<input type="text" name="twitter" value="<?php echo $result['t_link']; ?>"><br />
	<input type="text" name="youtube" value="<?php echo $result['y_link']; ?>"><br />
	<input type="submit" name="contact" value="Update">	
	</form>
	</div>
			   ...
			   <div class="section group">
				...
				<div class="col span_1_of_contact"><span id="red">1a</span>
					<?php global $connection; 
					$sql = "select * from contact ORDER BY id DESC limit 1";
					$query = mysqli_query($connection, $sql);
					$result = mysqli_fetch_array($query);
