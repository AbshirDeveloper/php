...
$sql="SELECT r_balance as total FROM amano where name = '$data->firstname'";
...
$sq = "INSERT INTO histor (time, pertain, status, transaction, new_balance, type)
VALUES ('$time', 'Office Itme Registration', 'N/A', 0, $total)"; 

$sql = "INSERT INTO amano (firstname, type)
VALUES ('$data->firstname', 'office')";
